...
client = Cloudant.iam('username','api key',connect=True)
...
def afterreg():
    ...
    if(len(docs.all())==0):
        ...
        return render_template('login.html',pred="Registeration successfull")
    else:
        return render_template('register.html',pred="You re already member,Login using your details")
